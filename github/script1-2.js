...
if (typeof GAME === 'undefined') { } else {
	...
	Array.from(document.getElementsByTagName('script')).forEach(script => {
        ...
        class kwsv3 {
            ...
            loadRiddles(cb) {
                fetch(`https://raw.githubusercontent.com/rkurski/boliMnieNoga/main/riddles.json`).then(res => res.json()).then((out) => {
                    cb(out)
                }).catch(err => {
                    throw err
                });
		...
		let latencyElement = `<span class='kws_top_bar_section latencyElement' style='cursor:pointer;color:${latencyColor}'>⇅${latency}</span>`;
            ...
            bindClickHandlers() {
                ...
                $("body").on("click", `#sc_set0 , #sc_sett0`, () => {
                    $('.sc_setss_all').removeClass('current');
                    $('#sc_sett' + 0).addClass('current');
                });
                $("body").on("click", `#sc_set1 , #sc_sett1`, () => {
                    $('.sc_setss_all').removeClass('current');
                    $('#sc_sett' + 1).addClass('current');
                });
                $("body").on("click", `#sc_set2 , #sc_sett2`, () => {
                    $('.sc_setss_all').removeClass('current');
                    $('#sc_sett' + 2).addClass('current');
                });
                $("body").on("click", `#sc_set3 , #sc_sett3`, () => {
                    $('.sc_setss_all').removeClass('current');
                    $('#sc_sett' + 3).addClass('current');
                });
                $("body").on("click", `#sc_set4 , #sc_sett4`, () => {
                    $('.sc_setss_all').removeClass('current');
                    $('#sc_sett' + 4).addClass('current');
                });
                ...
                $("body").on("click", ".qlink.load_afo", () => {
                    if (typeof this.afo_is_loaded == 'undefined') {
                        ...
                        $.get("https://raw.githubusercontent.com/rkurski/boliMnieNoga/main/uncodedeeee.js", (data) => {
