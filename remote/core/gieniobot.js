  ...
  let socketDetector = setInterval(() => {
    ...
    class Gieniobot {
      constructor(charactersManager) {
        ...
        this.addToCSS(`.manage_auto_clanAssist{border-radius:5px; border: 2px solid transparent;} .manage_auto_clanAssist:hover{border-color: #3fc1c9; box-shadow: 0 0 8px 2px #3fc1c9;} .manage_auto_clanAssist.kws_active_icon{animation-name:kws_active_clanassist !important;animation-duration:1s;animation-iteration-count:infinite; filter:none !important;}@keyframes kws_active_clanassist { 0% { box-shadow: 0 0 8px 2px #3fc1c9; border-color: #3fc1c9; } 50% { box-shadow: 0 0 8px 2px #f9ca24; border-color: #f9ca24; } 100% { box-shadow: 0 0 8px 2px #3fc1c9; border-color: #3fc1c9; } }`);
